...
<head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0">
		 ...
		 <link rel="stylesheet" href="<?php echo e(url('assets/css/maicons.css')); ?>">

      <link rel="stylesheet" href="<?php echo e(url('assets/css/bootstrap.css')); ?>">

        <link rel="stylesheet" href="<?php echo e(url('assets/vendor/owl-carousel/css/owl.carousel.css')); ?>">
		...
		<div class="main-wrapper">
				...
				<nav class="navbar navbar-expand-lg header-nav">
					<div class="navbar-header">
						...
						<a href="index-2.html" class="navbar-brand logo">
							<img src="<?php echo e(url('assets/img/logo.png')); ?>" class="img-fluid" alt="Logo">
						</a>
					</div>
            ...
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="nav-link header-login">Login</a>

                        <li>
									<?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="nav-link header-login">Register</a>
                        <?php endif; ?>
</li>
                    <?php endif; ?>
                </div>
			...
			<!-- /Header -->
			<div class="page-hero bg-image overlay-dark" style="background-image: url(<?php echo e(url('assets/img/bg_image_1.jpg);')); ?>">
  ...
  <div class="bg-light">
    <div class="page-section py-3 mt-md-n5 custom-index">
      <div class="container">
								...
								<div class="profile-widget">
									<div class="doc-img">
										<a href="doctor-profile.blade.php">
											<img class="img-fluid" alt="User Image" src="<?php echo e(url('assets/img/doctors/doctor_1.jpg')); ?>">
										</a>
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-about">
									<div class="footer-logo">
										<img src="<?php echo e(url('assets/img/logo-footer.png')); ?>" alt="logo">
									</div>
       ...
       <script src="<?php echo e(url('assets/vendor/owl-carousel/js/owl.carousel.min.js')); ?>"></script>
		...
		<!-- Slick JS -->
		<script src="<?php echo e(url('assets/js/slick.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\lravel_project\doctorweb\resources\views/welcome.blade.php ENDPATH**/ ?>